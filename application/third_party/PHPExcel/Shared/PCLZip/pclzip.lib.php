        ...
        while ($i < $p_size) {
            ...
            switch ($p_options_list[$i]) {
                ...
                case PCLZIP_OPT_PREPEND_COMMENT:
                    ...
                    if (($i + 1) >= $p_size) {
                        // ----- Error log
                        self::privErrorLog(PCLZIP_ERR_MISSING_OPTION_VALUE, "Missing parameter value for option '"
                    ...
                    if (is_string($p_options_list[$i + 1])) {
                        ...
                        // ----- Error log
                        self::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Wrong parameter value for option '"
                                . PclZipUtilOptionText($p_options_list[$i])
                                . "'");
                ...
                default:
                    // ----- Error log
                    self::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Unknown parameter '"
                            . $p_options_list[$i] . "'");
...
//      eval('$v_result = '.$p_options[PCLZIP_CB_POST_ADD].'(PCLZIP_CB_POST_ADD, $v_local_header);');
        ...
        for ($i = 0, $v_nb_extracted = 0; $i < $v_central_dir['entries']; ++$i) {
            ...
            if (($v_extract) && (($v_header['compression'] != 8) && ($v_header['compression'] != 0))) {
                ...
                if ((isset($p_options[PCLZIP_OPT_STOP_ON_ERROR])) && ($p_options[PCLZIP_OPT_STOP_ON_ERROR] === true)) {
                    ...
                    self::privErrorLog(PCLZIP_ERR_UNSUPPORTED_COMPRESSION, "Filename '" . $v_header['stored_filename'] . "' is "
            ...
            if (($v_extract) && (($v_header['flag'] & 1) == 1)) {
                ...
                if ((isset($p_options[PCLZIP_OPT_STOP_ON_ERROR])) && ($p_options[PCLZIP_OPT_STOP_ON_ERROR] === true)) {
                    ...
                    self::privErrorLog(PCLZIP_ERR_UNSUPPORTED_ENCRYPTION, 'Unsupported encryption for '
    ...
    public function privExtractFile(&$p_entry, $p_path, $p_remove_path, $p_remove_all_path, &$p_options) {
        ...
        if (isset($p_options[PCLZIP_OPT_EXTRACT_DIR_RESTRICTION])) {
            ...
            if ($v_inclusion == 0) {
                self::privErrorLog(PCLZIP_ERR_DIRECTORY_RESTRICTION, "Filename '" . $p_entry['filename'] . "' is "
        ...
        if ($p_entry['status'] == 'ok') {
            ...
            if (file_exists($p_entry['filename'])) {
                ...
                if (is_dir($p_entry['filename'])) {
                    ...
                    if ((isset($p_options[PCLZIP_OPT_STOP_ON_ERROR])) && ($p_options[PCLZIP_OPT_STOP_ON_ERROR] === true)) {
                        self::privErrorLog(PCLZIP_ERR_ALREADY_A_DIRECTORY, "Filename '" . $p_entry['filename'] . "' is "
                ...
                elseif (!is_writeable($p_entry['filename'])) {
                    ...
                    // when this kind of error occurs.
                    if ((isset($p_options[PCLZIP_OPT_STOP_ON_ERROR])) && ($p_options[PCLZIP_OPT_STOP_ON_ERROR] === true)) {
                        self::privErrorLog(PCLZIP_ERR_WRITE_OPEN_FAIL, "Filename '" . $p_entry['filename'] . "' exists "
                ...
                elseif (filemtime($p_entry['filename']) > $p_entry['mtime']) {
                    ...
                    if ((isset($p_options[PCLZIP_OPT_REPLACE_NEWER])) && ($p_options[PCLZIP_OPT_REPLACE_NEWER] === true)) {
                        ...
                        // when this kind of error occurs.
                        if ((isset($p_options[PCLZIP_OPT_STOP_ON_ERROR])) && ($p_options[PCLZIP_OPT_STOP_ON_ERROR] === true)) {
                            self::privErrorLog(PCLZIP_ERR_WRITE_OPEN_FAIL, "Newer version of '" . $p_entry['filename'] . "' exists "
...
//      eval('$v_result = '.$p_options[PCLZIP_CB_POST_EXTRACT].'(PCLZIP_CB_POST_EXTRACT, $v_local_header);');
    ...
    public function privReadEndCentralDir(&$p_central_dir) {
        ...
        if (($v_pos + $v_data['comment_size'] + 18) != $v_size) {
            ...
            if (0) {
                // ----- Error log
                self::privErrorLog(PCLZIP_ERR_BAD_FORMAT, 'The central dir is not at the end of the archive.'
