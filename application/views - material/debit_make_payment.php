...
$adv_payment_method = $orderDtaData[0]->adv_payment_method;
$adv_payment_method_name = $orderDtaData[0]->adv_payment_method_name;
$adv_card_number = $orderDtaData[0]->adv_card_number;
$adv_cheque_number = $orderDtaData[0]->adv_cheque_number;
$adv_paid_amt = $orderDtaData[0]->adv_paid_amt;
                            ...
                            <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px; border-top: 1px solid #000; border-collapse: collapse; width: 100%;">
                                <tbody>
                                    ...
                                    if ($order_disAmt > 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:left; padding-left:1.5%; padding-bottom: 5px;">
                                                <?php echo $lang_discount_amount; ?>&nbsp;<?php
                                    ...
                                    if (!empty($adv_payment_method_name)) {
                                        ?>
                                        <tr>    
                                            <td colspan="4" style="text-align:left; font-weight:bold; padding-top:5px; border-top: 1px solid #000;">Advance Payment Details</td>
                                        </tr>
