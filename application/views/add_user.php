                            ...
                            <div class="row clearfix">
								...
								<div class="col-sm-6">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="text" name="fullname" class="form-control"  maxlength="499" autofocus autocomplete="off" value="<?php	if (!empty($alert_msg)) {	echo $alert_msg[3];	}	?>" />
								...
								<div class="col-sm-6">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="email" name="email" class="form-control" maxlength="254" autocomplete="off" value="<?php  if (!empty($alert_msg)) {	echo $alert_msg[4];}?>" />
