...
<section class="content">
    <div class="container-fluid">
		<ol class="breadcrumb breadcrumb-bg-cyan">
            ...
            <li class="active"><i class="material-icons">remove_red_eye</i> <?php echo $lang_inventory_for_product; ?> : <?php echo $pcode; ?></li>
		</ol>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
						...
						<div class="row clearfix">
                            <div class="row">
                                <div class="col-md-3"><?php echo $lang_outlets; ?></div>
                                <div class="col-md-9"><?php echo $lang_current_inventory_qty; ?></div>
							</div>
                            <?php
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="row clearfix">
                                    <div class="row">
                                        <div class="col-md-3"><?php echo $lang_outlets; ?></div>
                                        <div class="col-md-9"><?php echo $lang_quantity; ?></div>
									</div>
                                    <?php
										if ($user_role == 1) {
											$outletData = $this->Constant_model->getDataOneColumnSortColumn('outlets', 'status', '1', 'name', 'ASC');
