    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <ol class="breadcrumb breadcrumb-bg-cyan">
                ...
                <li><i class="material-icons">report</i> <?php echo $lang_pnl_report; ?></li>
                                    ...
                                    <table class="table table-hover dashboard-task-infos">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align:center;"><?php echo $lang_cost_total; ?> (<?php echo $site_currency; ?>)</th>
                                                <th style="text-align:center;"><?php echo $lang_tax_total; ?> (<?php echo $site_currency; ?>)</th>
                                                <th style="text-align:center;"><?php echo $lang_profit_total; ?> (<?php echo $site_currency; ?>)</th>

                                            </tr>
                                        </thead>
                                        <tbody>
                                        <td style="text-align:center;">  <?php echo number_format($all_grand_amt, 2, '.', ''); ?></td>
                                        <td style="text-align:center;"> <?php echo number_format($all_cost_amt, 2, '.', ''); ?></td>
                                        <td style="text-align:center;"> <?php echo number_format($all_tax_amt, 2, '.', ''); ?></td>
                                        <td style="text-align:center;"> <?php echo number_format($all_profit_amt, 2, '.', ''); ?></td>
                                        </tbody>
                                    </table>
