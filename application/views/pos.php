<?php require_once 'includes/pos_header.php'; ?>
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <ol class="breadcrumb breadcrumb-bg-cyan">
                    ...
                    <li class="active"><i class="material-icons">store</i> POS</li>
                </ol>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" >
                                                    <table border="0">
                                                        <tr>
                                                            <td width="25%" height="25px"><?php echo $lang_total_items; ?> :</td>
                                        ...
                                        <div class="panel-body tabs">
                                            ...
                                            <div class="row" >
                                                <div class="col-md-12" style="border-bottom: 1px solid #ddd; padding-top: 11px;">
                                                    <?php /* <div class="regular slider" style="width: 100%">
                                                      <!--
