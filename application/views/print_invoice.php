            ...
            <table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
                ...
                <tr>
                    <td width="100%">
						...
						<?php 		if ($return_change > 0) {?>							
							<div><span class="left" style="text-align: Center;font-size: 20px;"> Total : ₹<strong><?php echo number_format(($paid_amt + $adv_paid_amt - $return_change), 2); ?></strong></span></div>
							<?php 	}else{?>
